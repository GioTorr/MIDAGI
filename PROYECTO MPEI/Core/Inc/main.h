...
#define Sharp_Pin GPIO_PIN_2
#define Sharp_GPIO_Port GPIOA
#define ACS712_Pin GPIO_PIN_3
#define ACS712_GPIO_Port GPIOA
#define Div__Bateria_Pin GPIO_PIN_4
#define Div__Bateria_GPIO_Port GPIOA
#define L298N_ENA_Pin GPIO_PIN_6
#define L298N_ENA_GPIO_Port GPIOA
#define L298N_ENB_Pin GPIO_PIN_7
